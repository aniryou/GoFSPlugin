...
import com.mckinsey.mdl.fsplugin.message.ValidationResultMessage;
import java.io.File;
...
public class PackageRepositoryConfigurationProvider {
    ...
    public PackageMaterialProperties repositoryConfiguration() {
        ...
        repositoryConfigurationResponse.addPackageMaterialProperty(Constants.DIR, dir());
    ...
    public PackageMaterialProperties packageConfiguration() {
        ...
        packageConfigurationResponse.addPackageMaterialProperty(Constants.FILE_NAME, fileName());
    ...
    private PackageMaterialProperty dir() {
        return new PackageMaterialProperty().withDisplayName("Directory").withDisplayOrder("0");
    }

    private PackageMaterialProperty fileName() {
        return new PackageMaterialProperty().withDisplayName("File Name").withDisplayOrder("1");
    }
}
