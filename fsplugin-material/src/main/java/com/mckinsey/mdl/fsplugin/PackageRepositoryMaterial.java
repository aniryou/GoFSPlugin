...
import com.mckinsey.mdl.fsplugin.message.*;

import java.util.LinkedHashMap;
import java.util.Map;

import static com.thoughtworks.go.plugin.api.response.DefaultGoPluginApiResponse.success;
import static com.mckinsey.mdl.fsplugin.JsonUtil.fromJsonString;
import static com.mckinsey.mdl.fsplugin.JsonUtil.toJsonString;
    ...
    MessageHandler latestRevisionMessageHandler() {
        return new MessageHandler() {
            ...
            public GoPluginApiResponse handle(GoPluginApiRequest request) {
                ...
                log.warn(toJsonString(revision));
